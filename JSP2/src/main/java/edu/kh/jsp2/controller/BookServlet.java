...
public class BookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		bookList.add(new Book("CSS란 무엇인가", "유관순", 30000));
		bookList.add(new Book("JSP란 무엇인가", "짱구", 5000));
		bookList.add(new Book("EL이란 무엇인가", "훈이", 12000));
		bookList.add(new Book("JSTL이란 무엇인가", "유리", 13000));
