...
public class TodoListServiceImpl implements TodoListService {
	...
	@Override
	public Todo todoDetail(int i) throws Exception {

		
		Connection conn = getConnection();
		
		Todo todo = dao.todoDetail(conn, i);
	...
	@Override
	public int updateTodo(int todoNo, String todoTitle, String updateDetail) throws Exception {

		Connection conn = getConnection();
		
		int result = dao.updateTodo(conn, todoNo, todoTitle, updateDetail);
